...
def configure_monitoring_system():
    ...
    try:
        ...
        security_event_condition = AlertCondition(
            ...
            threshold=10,  # 10 分钟内安全事件超过 10 次
            comparison=">",
        ...
        logger.error(f"⚠️ 配置监控系统时出现错误：{e}")
        # 即使配置失败，也要继续运行
