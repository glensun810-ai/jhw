    ...
    def run_async_test():
        try:
            ...
            try:
                ...
                api_logger.error(f"AI evaluation failed: {str(e)}")
                # 如果AI评估失败，填充默认的评估数据对象并强制将任务progress更新为100，is_completed设为true
                processed_results = {
                    'detailed_results': [],
                    'main_brand': {
                        'overallScore': 0,
                    ...
                    'summary': {'total_tests': 0, 'brands_tested': len(brand_list)}
                }
