...
| ID | 名称 | 状态 | 耗时 (ms) | 错误信息 |
|----|------|------|-----------|----------|
| SV-001 | ReportDataService 初始化 | ❌ FAIL | 0 | `导入失败：No module named 'ai_adapters'...` |
| SV-002 | _get_base_data 方法存在性 | 🔴 ERROR | 0 | `'wechat_backend'...` |
...
| ID | 名称 | 状态 | 耗时 (ms) | 错误信息 |
|----|------|------|-----------|----------|
| BE-001 | 空 execution_id 处理 | ❌ FAIL | 0 | `抛出异常：'wechat_backend'...` |
| BE-002 | None execution_id 处理 | ❌ FAIL | 0 | `抛出异常：'wechat_backend'...` |
| BE-003 | 超长 execution_id 处理 | ❌ FAIL | 0 | `抛出异常：'wechat_backend'...` |
