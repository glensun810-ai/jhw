...
def _semantic_analysis_fallback(text: str, log_context: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        for pattern, priority in rank_patterns:
...
# 写入文件
with open('/Users/sgl/PycharmProjects/PythonProject/backend_python/wechat_backend/ai_adapters/geo_parser.py', 'w', encoding='utf-8') as f:
    f.write(ENHANCED_GEO_PARSER.replace('\\\\', '\\'))

print("✓ geo_parser.py 已更新")
