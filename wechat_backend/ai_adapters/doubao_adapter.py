...
class DoubaoAdapter(AIClient):
    ...
    def __init__(self, api_key: str, model_name: str = "ep-20240520111905-bavcb", base_url: Optional[str] = None):
        ...
        api_logger.info(f"DoubaoAdapter initialized for model: {model_name}")
    ...
    def send_prompt(self, prompt: str, **kwargs) -> AIResponse:
        ...
        try:
            ...
            if response_data and response_data.get("choices"):
                ...
                api_logger.error(f"Doubao API returned no output: {error_message}")
    ...
    def _map_error_message(self, error_message: str) -> AIErrorType:
        ...
        if "invalid api key" in error_message_lower:
            return AIErrorType.INVALID_API_KEY
        if "insufficient quota" in error_message_lower:
            return AIErrorType.INSUFFICIENT_QUOTA
        if "content risk" in error_message_lower:
