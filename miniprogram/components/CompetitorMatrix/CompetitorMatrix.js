// components/CompetitorMatrix/CompetitorMatrix.js
Component({
  options: {
    addGlobalClass: true
  },
  ...
  methods: {
    updateKeywordData() {
      ...
      // 提取竞品拦截词
      const competitorKeywords = Array.isArray(competitionData.competitor_keywords)
        ? competitionData.competitor_keywords
        : Array.isArray(competitionData.competitorKeywords)
          ? competitionData.competitorKeywords
          : [];
