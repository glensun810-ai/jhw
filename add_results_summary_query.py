#!/usr/bin/env python3
"""
添加 results_summary 查询到 views.py
"""
...
for i, line in enumerate(lines, 1):
    ...
    # 在第 2585 行后添加 results_summary 查询
    if i == 2585 and "'message': 'Task found in database (server restarted)'" in line:
        new_lines.append("                }\n")
        new_lines.append("\n")
        ...
        new_lines.append("\n")
        new_lines.append("                # 如果任务已完成，尝试获取结果\n")
