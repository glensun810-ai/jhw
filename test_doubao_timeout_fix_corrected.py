...
def test_concurrent_execution_with_reduced_workers():
    ...
    # Check that max_workers is 3
    assert scheduler.max_workers == 3, f"Expected max_workers=3, got {scheduler.max_workers}"
    print(f"✅ Scheduler created with max_workers={scheduler.max_workers}")
...
def test_executor_initialization():
    ...
    assert executor2.scheduler.max_workers == 3, f"Expected max_workers=3, got {executor2.scheduler.max_workers}"
